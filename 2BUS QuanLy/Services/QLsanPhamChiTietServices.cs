...
namespace _2.BUS.Services
{
    public class QLsanPhamChiTietServices : IQLsanPhamChiTietServices
    {
        ...
        public List<sanPhamChiTiet> GetSanPhamCTFromDB()
        {
            _lstsanPhamCT = _sanPhamCT.GetSanPhamFromDB();
            return _lstsanPhamCT;
        }
        public List<ViewHienThi> getViewSPCT()
        {
            _lstView = (from a in GetSanPhamCTFromDB()
                        ...
                        select new ViewHienThi { SanPhamChiTiets = a, mauSacs = b, hangSXs = c, nhaCungCaps = d, chatLieus = e, sizes = f, sanPhams = g }).ToList();
            return _lstView;
        }
