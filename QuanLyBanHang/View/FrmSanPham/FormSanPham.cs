...
namespace QuanLyBanHang.View.FrmSanPham
{
    public partial class FormSanPham : Form
    {
        ...
        public FormSanPham()
        {
            ...
            LoadSanPham();
            LoadData();
            ptb_Anh.Image = Image.FromFile(@".\empty.jpg");
            imageLink = @".\empty.jpg";
        }
        ...
        private void LoadData()
        {
            ...
            List<ViewHienThi> listSPCT = _qlsanPhamChiTietServices.getViewSPCT();
            foreach (ViewHienThi item in listSPCT)
            {
                dtgv_SPCT.Rows.Add
                    (
        ...
        {
            if (txt_tenSPCT.Text == "" || txt_giaNhap.Text == "" || txt_giaBan.Text == "" || txt_soLuong.Text == "")
            {
            ...
            else
            {
                ...
                if (spct.IDSanPhamChiTiet.ToString().Length == 1)
                {
                    spct.maSP = spct.maSP + "0" + spct.IDSanPhamChiTiet.ToString();
                }
                else
                {
                    spct.maSP += spct.IDSanPhamChiTiet.ToString();
                }
                _qlsanPhamChiTietServices.UpdateSanPham(spct);
        ...
        private void btn_CapNhap_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    _sanphamCT.trangThai = false;
                }
                else
                {
                    _sanphamCT.trangThai = rdb_conHang.Checked == true ? true : false;
                }
        ...
        private void dtgv_SPCT_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            _sanphamCT = _qlsanPhamChiTietServices.GetSanPhamCTFromDB()
        ...
        private void txt_timKiem_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dtgv_SPCT.Rows.Clear();
                List<ViewHienThi> listSPCT = _qlsanPhamChiTietServices.getViewSPCT().Where(x => x.SanPhamChiTiets.TenSP.ToLower().Contains(txt_timKiem.Text.ToLower())).ToList();
                foreach (ViewHienThi item in listSPCT)
                {
                    dtgv_SPCT.Rows.Add
                        (
